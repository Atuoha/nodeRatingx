'use strict';const express=require("express"),app=express(),router=express.Router(),Rating=require("../../../models/Rating"),User=require("../../../models/User"),Company=require("../../../models/Company"),{adminAuth}=require("../../../helpers/authenticate");router.all("/*",adminAuth,(e,f,a)=>{e.app.locals.layout="admin";a()});
