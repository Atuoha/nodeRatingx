'use strict';const express=require("express"),app=express(),router=express.Router(),User=require("../../../models/User"),Company=require("../../../models/Company"),faker=require("faker"),fs=require("fs"),bcrypt=require("bcryptjs"),{isEmpty}=require("../../../helpers/upload-helpers"),{adminAuth}=require("../../../helpers/authenticate");router.all("/*",adminAuth,(b,d,a)=>{b.app.locals.layout="admin";a()});
