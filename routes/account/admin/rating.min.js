'use strict';const express=require("express"),app=express(),router=express.Router(),Company=require("../../../models/Company"),User=require("../../../models/User"),Rating=require("../../../models/Rating"),{adminAuth}=require("../../../helpers/authenticate");router.all("/*",(a,d,b)=>{a.app.locals.layout="admin";b()});router.get("/",(a,d)=>{Company.find().then(b=>{d.render("accounts/admin/company/subscribers_company_views",{title:"Admin|Company",companies:b})}).catch(b=>console.log(b))});
