'use strict';const express=require("express"),app=express(),router=express.Router(),User=require("../../../models/User"),Messaging=require("../../../models/Messaging");router.all("/*",(a,c,b)=>{a.app.locals.layout="messaging";b()});router.get("/",(a,c)=>{c.redirect("/user")});
