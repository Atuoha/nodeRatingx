'use strict';const express=require("express"),app=express(),router=express.Router(),User=require("../../../models/User"),Company=require("../../../models/Company"),fs=require("fs"),bcrypt=require("bcryptjs"),{isEmpty}=require("../../../helpers/upload-helpers"),{userAuth}=require("../../../helpers/authenticate");router.all("/*",userAuth,(b,d,a)=>{b.app.locals.layout="user";a()});
