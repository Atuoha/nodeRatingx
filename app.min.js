'use strict';const express=require("express"),app=express(),mongoose=require("mongoose"),flash=require("connect-flash"),session=require("express-session"),upload=require("express-fileupload"),handlebars=require("express-handlebars"),Handlebars=require("handlebars"),port=process.env.PORT||1777,path=require("path"),passport=require("passport"),bodyParser=require("body-parser"),{allowInsecurePrototypeAccess}=require("@handlebars/allow-prototype-access"),methodOverride=require("method-override"),{mongodbURI}=
